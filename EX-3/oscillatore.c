...
void verletvelocita(double x, double v,double W, double Eo,double dt, int n ){
  double E, a, temp;
  printf("#E' stato utilizzato l'algoritmo Velvet Velocita'\n");
  printf("#Legenda\n");
  printf("#1:t 2:x 3:v 4:dE\n");
  printf("0 %lf %lf 0\n",x ,v);
  a=-W*x;
...
void verletposizioni(double x, double v,double W, double Eo,double dt, int n ){
  double temp, E,x1,x2;
...
int scelta(){
  int s;
  fprintf(stderr,"+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
  fprintf(stderr,"Possono essere utilizzati 5 diversi tipi di algoritmo:\n");
  ...
  fprintf(stderr,"Per utilizzare l'algoritmo Verlet Velocità premere 4\n");
  fprintf(stderr,"Per utilizzare l'algoritmo Verlet Posizioni premere 5\n");
  fprintf(stderr,"+++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++++\n");
...
int main(){
  ...
  while(control==0){
    ...
    if(s==4){
      verletvelocita(x,v,W,Eo,dt,n);
      control=1;
    }

    if(s==5){
      verletposizioni(x,v,W,Eo,dt,n);
      control=1;
    }
